...
CITIES_DATA = {
    ...
    "澳门特别行政区": ["花地玛堂区", "花王堂区", "望德堂区", "风顺堂区", "嘉模堂区", "圣方济各堂区"],
    "台湾省": {
        ...
        "高雄市": ["新兴区", "前金区", "苓雅区", "盐埕区", "鼓山区", "旗津区", "前镇区", "三民区", "左营区", "楠梓区", "小港区", "凤山区", "林园区", "大寮区", "大树区", "大社区", "仁武区", "鸟松区", "冈山区", "桥头区", "燕巢区", "田寮区", "阿莲区", "路竹区", "湖内区", "茄萣区", "永安区", "弥陀区", "梓官区", "旗山区", "美浓区", "六龟区", "甲仙区", "杉林区", "内门区", "茂林区", "桃源区", "那玛夏区"],
        "基隆市": ["仁爱区", "信义区", "中正区", "中山区", "安乐区", "暖暖区", "七堵区"],
        "新竹市": ["东区", "北区", "香山区"],
        "嘉义市": ["东区", "西区"],
        "新竹县": ["竹北市", "竹东镇", "新埔镇", "关西镇", "湖口乡", "新丰乡", "芎林乡", "横山乡", "北埔乡", "宝山乡", "峨眉乡", "尖石乡", "五峰乡"],
        "苗栗县": ["苗栗市", "头份市", "竹南镇", "后龙镇", "通霄镇", "苑里镇", "造桥乡", "头屋乡", "公馆乡", "大湖乡", "泰安乡", "铜锣乡", "三义乡", "西湖乡", "卓兰镇", "狮潭乡", "三湾乡", "南庄乡"],
        ...
        "花莲县": ["花莲市", "凤林镇", "玉里镇", "新城乡", "太鲁阁", "秀林乡", "吉安乡", "寿丰乡", "光复乡", "丰滨乡", "瑞穗乡", "富里乡", "卓溪乡"],
...
def get_all_cities():
    ...
    """
    cities = []
    for province, cities_data in CITIES_DATA.items():
...
def get_cities_by_province(province):
    ...
    if province in CITIES_DATA:
        cities_data = CITIES_DATA[province]
        if isinstance(cities_data, list):
            return cities_data
        elif isinstance(cities_data, dict):
...
def search_cities(keyword):
    ...
    for province, cities_data in CITIES_DATA.items():
        if keyword in province.lower():
            if isinstance(cities_data, list):
                matched.extend(cities_data)
            elif isinstance(cities_data, dict):
                matched.extend(cities_data.keys())
        else:
            if isinstance(cities_data, list):
